...
def choose_surv_par( summary_fid, mass_bin, quantile_list, tolerance, n_tries, ncpu, CP, zmin, zmax, area,  seed, ndata_fid, mass_lim ):
    """
    ...
    ncount=NCountSimul (zmin, zmax, mass_lim[0] , mass_lim[1], area, seed )
