...
def summary_quantile( data, mass, q_list, obs ):
...
def choose_surv_par( summary_fid, summary_fidz, mass_bin, dz_bin, quantile_list, tolerance, n_tries, CP, zmin, zmax, area,  seed, ndata_fid, mass_lim, observable, ncpu=1 ):
    """
